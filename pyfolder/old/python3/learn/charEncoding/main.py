...
def print_line(line, encoding, errors):
    next_lang = line.strip()  # remove leading and trailing string white spaces
    raw_bytes = next_lang.encode(encoding, errors=errors)  # chars to bytes
    cooked_string = raw_bytes.decode(encoding, errors=errors)  # bytes to chars
...
main(languages, encoding, error)  # RETURNS main(language_file,encoding,errors)
# re-executes main() if not EOF

# example script below:
'''
In [2]: run main.py utf-8 strict
